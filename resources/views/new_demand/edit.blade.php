                        ...
                        <div class="card-body">
                            <div class="tab-content tabcontent-border">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form autocomplete="off" action="{{ route('new_demand.update', $demand->id) }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group @error('total') has-danger @enderror">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="total"
                                                                value="{{ $demand->male + $demand->female }}">
                                                            @error('total')
                                                                <div class="form-control-feedback" style="color: red;">
                                                                    {{ $message }} </div>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group @error('pin_date') has-danger @enderror">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="pin_date" value="{{ $demand->pin_date }}">
                                                            @error('pin_date')
                                                                <div class="form-control-feedback" style="color: red;">
                                                                    {{ $message }} </div>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group @error('pin_number') has-danger @enderror">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="pin_number" value="{{ $demand->pin_date }}">
                                                            @error('pin_number')
                                                                <div class="form-control-feedback" style="color: red;">
                                                                    {{ $message }} </div>
                                                            @enderror
