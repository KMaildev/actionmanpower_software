                    ...
                    <div class="form-body">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="total" readonly
                                            value="{{ $sending->sending_male + $sending->sending_female }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="remark" value="{{ $sending->remark }}">
                                        @error('remark')
                                            <div class="form-control-feedback" style="color: red;">
                                                {{ $message }} </div>
                                        @enderror
                        ...
                        <div class="form-actions">
                            <div class="card-body">
                                ...
                                <a href="{{ route('sending.index') }}" class="btn btn-dark">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreSending', '#edit-form') !!}
