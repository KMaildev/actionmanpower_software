            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap rowheaders table-scroll" role="region" aria-labelledby="HeadersCol"
                    ...
                    <table class="table table-bordered main-table py-5" id="export_excel">
                        <thead class="tbbg">
                            <th style="color: black; text-align: center; width: 1%;">#</th>
                            <th style="color: black; text-align: center;">Description</th>
                            <th style="color: black; text-align: center;">User</th>
                            <th style="color: black; text-align: center;">Action Log</th>
                            <th style="color: black; text-align: center;">Old Value</th>
